{ config, lib, ... }:
{
  programs.plasma = lib.mkIf config.de.enable.plasma {
    ...
    configFile = {
      ...
      "kwinrc"."Tiling/e0bc3b3d-743a-54f3-8bf3-9067777d103c"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      "kwinrc"."Wayland"."InputMethod[$e]" = "/etc/profiles/per-user/waltz/share/applications/org.fcitx.Fcitx5.desktop";
